...
class DataTransformation:
    ...
    def initiate_data_transformation(self)-> DataTransformationArtifact:
        try:
            ...
            ## training dataframe
            input_feature_train_df=train_df.drop(columns=[TARGET_COLUMN],axis=1) #dropping the target column - independent features
            target_feature_train_df = train_df[TARGET_COLUMN] # dependent feature
            target_feature_train_df = target_feature_train_df.replace(-1, 0) #to keep the values as 1 , 0
